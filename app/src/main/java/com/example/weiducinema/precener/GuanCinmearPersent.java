 ...
 * on 2019/1/24
 */
public class GuanCinmearPersent extends BasePresenter {


    public GuanCinmearPersent(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.getGuanC((String)args[0],(String)args[1],(String)args[2]);
    }
}
