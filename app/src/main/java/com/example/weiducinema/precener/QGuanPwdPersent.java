 ...
 * on 2019/1/24
 */
public class QGuanPwdPersent extends BasePresenter {


    public QGuanPwdPersent(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.getQGuan((String)args[0],(String)args[1],(String)args[2]);
    }
}
