 ...
 * on 2019/1/24
 */
public class YuanCinemaPersent extends BasePresenter {


    public YuanCinemaPersent(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.getTui((String)args[0],(String)args[1],(String)args[2],(String)args[3]);
    }
}
