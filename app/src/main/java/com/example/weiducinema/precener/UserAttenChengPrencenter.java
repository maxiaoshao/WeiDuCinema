 ...
 * on 2019/1/24
 */
public class UserAttenChengPrencenter extends BasePresenter {


    public UserAttenChengPrencenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.getUserChang((String)args[0],(String)args[1],(String)args[2],(String)args[3]);
    }
}
