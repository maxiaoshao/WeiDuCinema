 ...
 * on 2019/1/24
 */
public class QueryPaiPrencenter extends BasePresenter {


    public QueryPaiPrencenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return iRequest.getQueryPai((String)args[0],(String)args[1]);
    }
}
